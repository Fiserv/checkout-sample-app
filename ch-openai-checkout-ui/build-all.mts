...
const defaultBaseUrl = "http://localhost:4443";
...
const healthDir = path.join(outDir, "actuator");
fs.mkdirSync(healthDir, { recursive: true });
fs.writeFileSync(path.join(healthDir, "health"), JSON.stringify({ status: "UP" }), { encoding: "utf8" });
console.log("Created health check endpoint: /actuator/health");
